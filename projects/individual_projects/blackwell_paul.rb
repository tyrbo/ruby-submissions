{
  :last_name => "Blackwell",
  :first_name => "Paul",
  :project_name => "Harvesting Tomatoes",
  :project_description => "I'm creating an application that integrates pomodoros with the harvest app.
  I guess it will also be integrating google calendar. A big problem with Harvest is that you forget that you
