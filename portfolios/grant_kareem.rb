{
  ...
  :looking_for => ["Working alongside engineers that love what they do", 'Solving challenging problems on a daily basis', "Working with companies committed to the growth of their engineers"],
  ...
  :code => {
    ...
    :project_3 => {
      ...
      :what_to_look_for => ['my approach to refactoring']
    }
  }
}
